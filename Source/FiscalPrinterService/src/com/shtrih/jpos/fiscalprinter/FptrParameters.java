...
public class FptrParameters {
    ...
    public String receiptVoidText = "вей нрлемем";
    ...
    public String[] taxNames = {"ю", "а", "б", "ц"};
    ...
    public boolean allowDiscountsWorkaroundFS = false;
    ...
    public void load(JposEntry entry) throws Exception {
        ...
        allowDiscountsWorkaroundFS = reader.readBoolean("allowDiscountsWorkaroundFS", false);
