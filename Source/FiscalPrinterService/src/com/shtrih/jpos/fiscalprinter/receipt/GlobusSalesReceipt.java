...
public class GlobusSalesReceipt extends CustomReceipt implements FiscalReceipt {
    ...
    private static final String PrinterChargeText = "ÍÀÄÁÀÂÊÀ";
    private static final String PrinterDiscountText = "ÑÊÈÄÊÀ";
    private static final String PrinterVoidChargeText = "ÑÒÎÐÍÎ ÍÀÄÁÀÂÊÈ";
    private static final String PrinterVoidDiscountText = "ÑÒÎÐÍÎ ÑÊÈÄÊÈ";
