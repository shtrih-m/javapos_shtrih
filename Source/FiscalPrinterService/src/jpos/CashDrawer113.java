  ...
  implements CashDrawerControl113, JposConst
{
    ...
    implements EventCallbacks
  {
    ...
    {
      return (BaseControl)CashDrawer113.this;
    }
    ...
    {
      synchronized(CashDrawer113.this.directIOListeners)
      {
    ...
    {
      synchronized(CashDrawer113.this.statusUpdateListeners)
      {
        // deliver the event to all registered listeners
