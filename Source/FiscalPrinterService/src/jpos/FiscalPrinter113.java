  ...
  implements FiscalPrinterControl113, JposConst
{
    ...
    implements EventCallbacks
  {
    ...
    {
      return (BaseControl)FiscalPrinter113.this;
    }
    ...
    {
      synchronized(FiscalPrinter113.this.directIOListeners)
      {
    ...
    {
      synchronized(FiscalPrinter113.this.errorListeners)
      {
        // deliver the event to all registered listeners
    ...
    {
      synchronized(FiscalPrinter113.this.outputCompleteListeners)
      {
        // deliver the event to all registered listeners
    ...
    {
      synchronized(FiscalPrinter113.this.statusUpdateListeners)
      {
        // deliver the event to all registered listeners
