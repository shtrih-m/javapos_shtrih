...
public class SerialPrinterPortSingle {
    ...
    private static Map<String, SerialPrinterPortSingle> items = new HashMap<String, SerialPrinterPortSingle>();

    public static synchronized SerialPrinterPortSingle getInstance(String portName) throws Exception {
        SerialPrinterPortSingle item = items.get(portName);
        if (item == null) {
            item = new SerialPrinterPortSingle(portName);
     ...
     */
    private SerialPrinterPortSingle(String portName) {
