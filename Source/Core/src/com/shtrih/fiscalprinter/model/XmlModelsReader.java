...
public class XmlModelsReader {
    ...
    private void loadModel(Node node) throws Exception {
        try {
            ...
            model.setCapCashInAutoCut(readParameterBool(node,"CapCashInAutoCut"));
            model.setCapCashOutAutoCut(readParameterBool(node,"CapCashOutAutoCut"));
            model.setCapPrintBarcode2(readParameterBool(node,"CapPrintBarcode2"));
