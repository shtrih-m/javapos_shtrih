...
public class XmlPropWriter {
    ...
    public void write(PrinterImage image) throws Exception {
        ...
        addParameter(imageNode, "Height", image.getHeight());
        addParameter(imageNode, "FirstLine", image.getStartPos());
    ...
    public void write(ReceiptImage image) throws Exception {
        ...
        node.appendChild(imageNode);
        addParameter(imageNode, "ImageIndex", image.getImageIndex());
        addParameter(imageNode, "Position", image.getPosition());
    }
